    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" autocomplete="off" >
        ...
        <!-- <div class="modal-body tabbable tab-content form-group">
          ...
          <div class="tab-pane" id="supplier-page-1">
            ...
            <a href="#supplier-page-2" data-toggle="tab" class="btn btn pull-right">
              <button id="first-button" type="button" class="btn btn-primary">Next</button>
            </a>
          ...
          <div class="tab-pane" id="supplier-page-2">
            ...
            <a href="#supplier-page-3" data-toggle="tab" class="btn btn pull-right">
              <button id="second-button" type="button" class="btn btn-primary pull-right">Next</button>
            </a>

            <a href="#supplier-page-1" data-toggle="tab" class="btn btn pull-left">
