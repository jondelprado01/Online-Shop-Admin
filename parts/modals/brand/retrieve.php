...
?>
  ...
  <div class="modal fade" id="retrieve-brand<?php echo $id ?>"  role="dialog" style="width: 100%" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form role="form" method="post" autocomplete="off" >
            ...
            <h4>Are you sure do you want to retrieve "<?php echo $brand ?>"?</h4>
